            ...
            <footer>
                <div className="first-section">
                    ...
                    <p className="footer-text">
                        <svg className="res-icon" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                        ...
                        <a href="tel:09300515480">09300515480</a>
                    </p>
                    <p className="footer-text">
                        <svg className="res-icon" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                        ...
                        <a href="mailto:labuguendarrel@gmail.com">labuguendarrel@gmail.com</a>
                    </p>
                </div>
                <div className="second-section">
                    <p className="footer-title">Socials</p>
                    <a href="https://www.facebook.com/darrel.labuguen.9" className="footer-text">
                        https://www.facebook.com/darrel.labuguen.9
                    </a>
                    <a href="https://www.instagram.com/darrel_labuguen/" className="footer-text">
                        https://www.instagram.com/darrel_labuguen/
                    </a>
                </div>
            </footer>
        </>
